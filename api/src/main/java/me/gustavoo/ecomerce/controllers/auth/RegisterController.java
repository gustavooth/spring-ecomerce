...
import me.gustavoo.ecomerce.controllers.RequestBody.RegisterBody;
...
public class RegisterController {
    ...
    @PostMapping
    public ApiResponse<AuthResponse> handleRegister(@RequestBody RegisterBody body, @NonNull HttpServletRequest request) {
