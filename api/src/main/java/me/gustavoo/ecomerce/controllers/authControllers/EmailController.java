...
import me.gustavoo.ecomerce.controllers.requestModels.EmailRequest;
...
import me.gustavoo.ecomerce.controllers.responseModels.EmailResponse;
...
public class EmailController {
    ...
    @PostMapping
    public ApiResponse<EmailResponse> emailResponse(@RequestBody EmailRequest body) {
