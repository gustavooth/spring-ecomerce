...
import me.gustavoo.ecomerce.controllers.responseModels.*;
...
import me.gustavoo.ecomerce.controllers.requestModels.LoginRequest;
...
public class LoginController {
    ...
    @PostMapping
    ApiResponse<AuthResponse> handleLogin(@RequestBody LoginRequest body, @NonNull HttpServletRequest request) {
        ...
        if (user_state_response.isPresent() && user_state_response.get().state.startsWith("login")) {
            ...
            if (user_response.isPresent()) {
                ...
                if (user_data.password.equals(body.password())){
